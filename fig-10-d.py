...
plt.ylim((0, 2100))
plt.xlim((0, 160))
# plt.yticks(np.arange(0, 2000.1, 400), rotation = 45)
plt.yticks(np.arange(0, 2000.1, 400), ['0', '400', '800', '1.2k', '1.6k', '2k'], rotation = 45)
plt.ylabel('Response time (ms)', labelpad = 0)
plt.xlabel('(d) timestamp (second)', labelpad=0)
...
plt.tight_layout()
plt.savefig('fig-10-d.png' ,bbox_inches='tight', dpi=400, pad_inches=0.01)
